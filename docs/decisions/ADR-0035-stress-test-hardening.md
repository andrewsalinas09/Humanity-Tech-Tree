# ADR-0035: Stress-test hardening — 17 rules from the 2026-08-10 red-team
...
**H5 — The Un-merge verb exists** *(amends ADR-0011/0012; TB-051).* Un-merge = forward-edit reversal of the redirect reopening the merged node + automatic enqueue of all record-time-post-merge assertions into check-queue triage with three outcomes: keep / move / **park-at-LCA** (the mandatory ambiguity default — no assertion is ever forced into a possibly-false home).
