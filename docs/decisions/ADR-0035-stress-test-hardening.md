...
**H5 — The Un-merge verb exists** *(amends ADR-0011/0012; TB-051; extended per user 2026-08-10).* Un-merge = forward-edit reversal of the redirect reopening the merged node + triage of assertions (the Q-04 LLM-proposes/human-confirms shape), with:
