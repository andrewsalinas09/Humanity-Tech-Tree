...
4. Possible machinery when it bites: a "wiring campaign" bounty kind (subject = the new hub; fulfillments = justified edges). Undecided; revisit when a real ubiquitous node lands.
