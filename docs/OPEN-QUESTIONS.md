...
**Status:** Nearly resolved — ALL semantic sub-decisions ruled 2026-08-09 round 2 (see ADR-0052 §Second ruling round; +TB-076/077). Remaining: verb naming + the Siemens worked example + implementation.
